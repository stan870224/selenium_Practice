...
from photo_Downloader import instagram_login, is_private_account, get_all_post_links, download_post_images
import time
...
# 獲取貼文連結
all_links = get_all_post_links(driver, target_user, num_posts)
